...
public class PessoaService implements IService<Pessoa, Integer> {
    ...
    public Pessoa updatePatch(Pessoa entity, Integer id) throws Exception {
         ...
         * 
         * 
         * //Exemplo 2, é possível fazer o gravar o objeto no banco, porém temos um
         * erro.
         * //O erro está relacionado a confiança no usuário, onde o usuário
         * obrigatoriamente
         * //precisda informar um ID que já esteja no banco de dados
         * //Caso seja um novo 'id', será criado um novo registro. Não haverá uma
         * atualização.
         * entity.setId(id);
        ...
        /**
         * Exemplo 3, para evitar a situação do exemplo 2, precisamos seguir os
         * seguintes passos:
